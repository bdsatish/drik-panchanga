...
def main():
  parser = argparse.ArgumentParser(description="Compare policy festival dates vs traditional over years.")
  parser.add_argument(
    "--policy",
  ...
  for y in years:
    ...
    try:
      ...
      janma_rule = next((r for r in FESTIVAL_RULES if r.number == JANMASHTAMI_NUMBER), None)
  ...
  print(f"OVERALL: {total_match}/{total_pol}  "
